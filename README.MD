...
1) Run `./gradlew :kmp-persistance:publishToMavenLocal`
2) Open `~/.m2/repository/com/mandor/kmp/persistance/`
...
2) Add developer id, name, email and the project url to  
   `./kmp-persistance/build.gradle.kts`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :kmp-persistance:publishAndReleaseToMavenCentral --no-configuration-cache`
